		...
		<div id="show-conta" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link controller="conta" action="credit" id="${contaInstance.id}">Creditar</g:link>
					<g:link controller="conta" action="debit" id="${contaInstance.id}">Debitar</g:link>
					<g:link controller="conta" action="transfer" id="${contaInstance.id}">Transferir</g:link>
				</fieldset>
			</g:form>
		</div>
	</body>
